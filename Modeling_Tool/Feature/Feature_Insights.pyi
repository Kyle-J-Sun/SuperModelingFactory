...
class VarExtractionInsights:
    def __init__(self, data, dep, plot_path, nbins = 10, equal_freq = True, min_bin_prop = 0.05, precision = 5, chi2_method = False, chi2_p = 0.9, init_equi_bins = 5000, tree_binning = True, include_missing = True, seed = 3407, missing_rate_ref = -999999, spec_values = None, woe_engine = 'master', woe_binner: Any = None, woe_engine_params: dict = None): ...
...
class CorrelationFilter:
    def __init__(self, data, dep, corr_cutpoint = 0.8, method = 'pearson', tree_binning = False, chi2_method = False, seed = 42, chi2_p = 0.999, init_equi_bins = 1000, missing_rate_ref = -9999999, spec_values = [], base_metric = 'iv', woe_engine = 'master', woe_binner: Any = None, woe_engine_params: dict = None): ...
