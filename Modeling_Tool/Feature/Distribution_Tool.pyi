...
class proc_means:
    def __init__(self, data, varlist, groupby, spec_missing_value = None, feature_block_size = 128): ...
    def treat_spec_missing(self): ...
    def group_means(self, q = None): ...
    def group_sum(self): ...
    def __call__(self, q = None): ...
def proc_means_by_grp(data, varlist, groupby = None, spec_missing_value = None, q = None, feature_block_size = 128): ...
def proc_means_for_screening(data, varlist, spec_missing_value = None, q = None, feature_block_size = 128): ...
