...
class PSICalculator:
    def __init__(self, buckets: int = 10, equal_freq: bool = True, min_bin_prop: float = 0.05, content: float = 1e-06, precision: int = 5, binning_engine: Any = None, missing_policy: str = "include", psi_missing_bucket_policy: str = "smooth_laplace", feature_block_size: Optional[int] = 64): ...
