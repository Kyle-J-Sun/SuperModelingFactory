...
class SampleSplitter:
    ...
    def split_indices(self, index: Union[pd.Index, np.ndarray, List[Any]], y: Union[pd.Series, np.ndarray], test_size: Optional[float] = None, stratify: Optional[bool] = None) -> Tuple[np.ndarray, np.ndarray]: ...
