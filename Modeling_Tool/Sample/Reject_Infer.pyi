...
class RejectInferrer(ABC):
    def __init__(self, target_col: str = 'target', score_col: str = 'score', score_direction: str = 'high_good', random_state: Optional[int] = None): ...
...
class SimpleAugmentInferrer(RejectInferrer):
    def __init__(self, target_col: str = 'target', score_col: str = 'score', bad_rate: Optional[float] = None, score_direction: str = 'high_good', random_state: Optional[int] = None): ...
    def infer(self, df_approved: pd.DataFrame, df_rejected: pd.DataFrame, score_col: Optional[str] = None) -> pd.DataFrame: ...

class HardCutoffInferrer(RejectInferrer):
    def __init__(self, target_col: str = 'target', score_col: str = 'score', cutoff: float = 0.5, score_direction: str = 'high_good', random_state: Optional[int] = None): ...
    def infer(self, df_approved: pd.DataFrame, df_rejected: pd.DataFrame, score_col: Optional[str] = None) -> pd.DataFrame: ...
...
class ParcelingInferrer(RejectInferrer):
    def __init__(self, target_col: str = 'target', score_col: str = 'score', n_parcels: int = 10, score_direction: str = 'high_good', random_state: Optional[int] = None): ...
    def infer(self, df_approved: pd.DataFrame, df_rejected: pd.DataFrame, score_col: Optional[str] = None) -> pd.DataFrame: ...
