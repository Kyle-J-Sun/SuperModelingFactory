...
class MonotoneWOEBinner:
    ...
    def _enforce_small_bins(self, df_normal: pd.DataFrame, feat: str, edges: list, wt: pd.DataFrame, merge_trace: Optional[list]): ...
    ...
    def _dtree_edges(df_normal: pd.DataFrame, feat: str, target_col: str, max_bins: int, min_samples_leaf, max_depth: Optional[int] = None) -> list: ...
    def _monotone_merge_edges(df_normal: pd.DataFrame, feat: str, target_col: str, edges: list, eps: float, direction: Optional[int] = None) -> list: ...
    def refine_dtree(self, df: pd.DataFrame, features: Optional[List[str]] = None, max_bins: int = 6, min_samples_leaf: float = 0.05, monotone: bool = True, n_jobs: int = 1, max_depth: Optional[int] = None) -> 'MonotoneWOEBinner': ...
    ...
    def apply_woe(self, data: pd.DataFrame, suffix: str = '_woe', inplace: bool = False, unseen_category_policy: str = 'warn', varlist: Optional[List[str]] = None) -> pd.DataFrame: ...
