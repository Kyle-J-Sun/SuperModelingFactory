...
_PIPELINE_EXPORTS = frozenset({
    ...
    'FieldMeta', 'PipelineRegistryEntry', 'PIPELINE_REGISTRY', 'get_pipeline_registry',
    'get_pipeline_registry_schema', 'get_config_field_meta', 'extract_config_schema',
    'extract_pipeline_schema', 'extract_schema', 'config_to_dict', 'config_from_dict',
    'config_to_yaml', 'config_from_yaml', 'validate_pipeline_config', 'generate_pipeline_code',
})
